# simple_radios.py
# from [Creating Interactive PDF Forms in ReportLab with Python - Mouse Vs Python](https://www.blog.pythonlibrary.org/2018/05/29/creating-interactive-pdf-forms-in-reportlab-with-python/)
